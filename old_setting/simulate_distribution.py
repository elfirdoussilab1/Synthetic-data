...
for i, beta in enumerate(betas):
    ...
    mean_c2 = test_expectation(n, m, p, mu, mu_orth, beta, sigma, epsilon, rho, phi, gamma)
    mean_c1 = - mean_c2
...
path = './study-plot' + f'/distribution-n-{n}-m-{m}-p-{p}-mu-{mu}-mu_orth-{mu_orth}-sigma-{sigma}-epsilon-{epsilon}-rho-{rho}-phi-{phi}.pdf'
